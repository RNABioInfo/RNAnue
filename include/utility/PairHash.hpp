...
struct PairHash {
    static constexpr auto hashCombine(size_t lhs, size_t rhs) -> size_t {
    ...
    constexpr auto operator()(const std::pair<T1, T2>& pair) const -> std::size_t {
    ...
    constexpr auto operator()(const std::pair<seqan3::dna5_vector, seqan3::dna5_vector>& pair) const
        -> std::size_t {
