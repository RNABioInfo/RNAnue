...
if(HTSlib_FOUND)
    ...
    BUILD_IN_SOURCE 1
    UPDATE_COMMAND ""
    CONFIGURE_COMMAND echo "ZLIB_CONF: " && printenv LOCAL_ZLIB_CONFIG && autoreconf -i && ./configure --prefix=${htslib_PREFIX} ${disable_flags} CXX=$ENV{CXX} CC=$ENV{CC} $ENV{LOCAL_ZLIB_CONFIG}
